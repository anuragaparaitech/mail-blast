            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 16px;">
              ...
              <div class="form-group">
                <label class="form-label" style="display: flex; justify-content: space-between; align-items: center;">
                  ...
                  <span style="font-size: 0.72rem; color: ${s.smtp_pass ? 'var(--color-success)' : 'var(--text-muted)'}; font-weight: 600;">
                    ${s.smtp_pass ? '✅ Saved in Database' : '⚠️ Not Configured'}
                  </span>
                </label>
                <div style="position: relative; display: flex; align-items: center;">
                  <input type="password" id="smtpPassInput" name="smtp_pass" class="form-input" value="${s.smtp_pass || ''}" placeholder="e.g. 16-character App Password" style="padding-right: 42px;" />
                  <button type="button" onclick="SettingsView.togglePasswordVisibility()" style="position: absolute; right: 8px; background: none; border: none; cursor: pointer; color: var(--text-muted); padding: 4px;" title="Show/Hide Password">
                ...
                <p style="font-size: 0.72rem; color: var(--text-muted); margin-top: 4px;">For Gmail: Use a 16-character Google App Password. Saved securely in database.</p>
              </div>
            </div>
